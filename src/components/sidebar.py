...
def render_sidebar():
    ...
    ">
        ...
        {f'''<div style="margin-top: 0.75rem; padding: 0.2rem 0.5rem; background: rgba(16, 185, 129, 0.1); border: 1px solid rgba(16, 185, 129, 0.2); border-radius: 6px; display: inline-flex; align-items: center; gap: 0.35rem;">
            <span style="width: 6px; height: 6px; border-radius: 50%; background: #10B981; box-shadow: 0 0 5px #10B981;"></span>
            <span style="color: #10B981; font-size: 0.6rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em;">Running in Docker</span>
    ...
    st.markdown('<div style="height:1px;background:#1A2236;margin:0.75rem 1.25rem;"></div>', unsafe_allow_html=True)
